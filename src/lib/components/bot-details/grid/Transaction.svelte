...
<div class="flex flex-col gap-3 p-3">
	<div class="card !shadow-sm p-3 flex justify-between">
		<div>
			<div class="pb-2 text-xs text-gray-400/80">24H</div>
			<div class="font-bold text-center">1</div>
		</div>

		<div>
			<div class="pb-2 text-xs text-gray-400/80">History</div>
			<div class="font-bold text-center">1</div>
		</div>

		<div>
			<div class="pb-2 text-xs text-gray-400/80">Avg txs/day</div>
			<div class="font-bold text-center">1</div>
		</div>
	</div>
